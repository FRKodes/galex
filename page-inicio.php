		...
		<main id="main" class="site-main" role="main">
			...
			<div class="container-fluid brands">
				<div class="block-unity">
					<a href="diversiones-galex"><img src="<?php echo destino_final($_SERVER['HTTP_HOST']) ?>/wp-content/themes/galex/images/galex-diversiones.jpg" alt=""></a>
				...
				<div class="block-unity">
					<a href="galex-kids"><img src="<?php echo destino_final($_SERVER['HTTP_HOST']) ?>/wp-content/themes/galex/images/galex-kids.jpg" alt=""></a>
				...
				<div class="block-unity">
					<a href="galex-bowl"><img src="<?php echo destino_final($_SERVER['HTTP_HOST']) ?>/wp-content/themes/galex/images/galex-bowl.jpg" alt="Galex Bowl"></a>
