...
<div class="container all-content">
	...
	<div class="form-group">
		<div class="styled-select">
			<select name="motivo" id="motivo">
				<option value="">Elige tu unidad Galex</option>
				<option value="Diversiones Galex">Diversiones Galex</option>
				<option value="Galex Kids">Galex Kids</option>
				<option value="Galex Bowl">Galex Bowl</option>
